...
Route::group(['middleware' => ['auth:api', 'verify.data.access']], function () {
    ...
    Route::get('screening-questionnaires-history-by-patient-list', [ScreeningQuestionnaireController::class, 'listHistoryScreeningQuestionnaireByPatient'])->middleware('role:view_interview_screening_questionnaire_history');
    ...
    Route::name('patient.')->group(function () {
        ...
        Route::post('patient/transfer-to-therapist/{id}', [ForwarderController::class, 'store'])->middleware('role:manage_patient,manage_phc_worker,delete_phc_worker,delete_therapist,manage_therapist');
