            ...
            foreach ($globalQuestionnaires as $globalQuestionnaire) {
                DB::table('questionnaires')->updateOrInsert(
                    ...
                    [
                        ...
                        'is_used' => $globalQuestionnaire->is_used,
                        'auto_translated' => json_encode($globalQuestionnaire->auto_translated),
                        'parent_id' => $globalQuestionnaire->parent_id,
                        'suggested_lang' => $globalQuestionnaire->suggested_lang,
                        'share_to_hi_library' => $globalQuestionnaire->share_to_hi_library,
                        'share_with_phc_worker' => $globalQuestionnaire->share_with_phc_worker,
                        'include_at_the_start' => $globalQuestionnaire->include_at_the_start,
                        'include_at_the_end' => $globalQuestionnaire->include_at_the_end,
                        'is_survey' => $globalQuestionnaire->is_survey,
