            ...
            foreach ($globalExercises as $globalExercise) {
                DB::table('exercises')->updateOrInsert(
                    ...
                    [
                        ...
                        'parent_id' => $globalExercise->parent_id,
                        'suggested_lang' => $globalExercise->suggested_lang,
                        'share_to_hi_library' => $globalExercise->share_to_hi_library,
                        'share_with_phc_worker' => $globalExercise->share_with_phc_worker,
