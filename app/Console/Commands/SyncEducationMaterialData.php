            ...
            foreach ($globalEducationMaterials as $globalEducationMaterial) {
                DB::table('education_materials')->updateOrInsert(
                    ...
                    [
                        ...
                        'parent_id' => $globalEducationMaterial->parent_id,
                        'suggested_lang' => $globalEducationMaterial->suggested_lang,
                        'share_to_hi_library' => $globalEducationMaterial->share_to_hi_library,
                        'share_with_phc_worker' => $globalEducationMaterial->share_with_phc_worker,
