...
class PatientTreatmentPlanSurveyTemplate
{
    /**
    ...
    public function template($data, $sheet, $translations)
    {
        $columns = [
            ...
            $translations['report.patient_raw_data.health_condition_group'],
            $translations['report.patient_raw_data.health_condition'],
            ...
            $translations['report.patient_raw_data.survey'],
            $translations['report.patient_raw_data.survey.initial_satisfaction'],
            $translations['report.patient_raw_data.survey.final_satisfaction'],
        ];
