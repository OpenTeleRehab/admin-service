...
class PatientTreatmentTemplate
{
    ...
    public function template($data, $sheet, $translations)
    {
        $columns = [
            ...
            $translations['report.patient_raw_data.treatment_average_adherence'],
            $translations['report.patient_raw_data.treatment_pain'],
            $translations['report.patient_raw_data.treatment_average_pain'],
            $translations['report.patient_raw_data.treatment_daily_goal.achievement_satisfaction'],
            $translations['report.patient_raw_data.treatment_average_daily_goal.achievement_satisfaction'],
            $translations['report.patient_raw_data.treatment_weekly_goal.achievement_satisfaction'],
            $translations['report.patient_raw_data.treatment_average_weekly_goal.achievement_satisfaction'],
            $translations['report.patient_raw_data.questionnaire_results_at_the_start'],
            $translations['report.patient_raw_data.questionnaire_results_at_the_end'],
        ];
